...
/**
 * @brief Calculate gyroscope offsets
 *
 * @param sensor object handle of mpu6050
 * @param console whether to print debug information
 * @param delayBefore delay before calculating offsets
 * @param delayAfter delay after calculating offsets
 */
