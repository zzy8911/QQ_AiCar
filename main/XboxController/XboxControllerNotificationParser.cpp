...
string XboxControllerNotificationParser::toString() {
  ...
  string str = string("") +
    ...
    "btnLB: " + (btnLB ? "1" : "0") + " " +
    "btnRB: " + (btnRB ? "1" : "0") + "\n" +
    "btnSelect: " + (btnSelect ? "1" : "0") + " " +
    "btnStart: " + (btnStart ? "1" : "0") + " " +
    "btnXbox: " + (btnXbox ? "1" : "0") + " " +
    "btnShare: " + (btnShare ? "1" : "0") + " " +
    "btnLS: " + (btnLS ? "1" : "0") + " " +
    "btnRS: " + (btnRS ? "1" : "0") + "\n" +
    "btnDirUp: " + (btnDirUp ? "1" : "0") + " " +
    "btnDirRight: " + (btnDirRight ? "1" : "0") + " " +
    "btnDirDown: " + (btnDirDown ? "1" : "0") + " " +
    "btnDirLeft: " + (btnDirLeft ? "1" : "0") + "\n"
    "joyLHori: " + std::to_string(joyLHori) + "\n" +
    "joyLVert: " + std::to_string(joyLVert) + "\n" +
    "joyRHori: " + std::to_string(joyRHori) + "\n" +
    "joyRVert: " + std::to_string(joyRVert) + "\n" +
    "trigLT: " + std::to_string(trigLT) + "\n" +
    "trigRT: " + std::to_string(trigRT) + "\n";
  // clang-format on
  return str;
}
